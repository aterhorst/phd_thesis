...
\begin{center}
	\begin{longtable}{c p{2cm} p{3cm} p{3cm} P{7cm} P{3cm} P{3cm}}
		...
		\toprule 
		\multicolumn{1}{c}{Item} & \multicolumn{1}{c}{Theme} & \multicolumn{1}{c}{Construct} & \multicolumn{1}{c}{Scale Name} & \multicolumn{1}{c}{Question} & \multicolumn{1}{c}{Response} & \multicolumn{1}{c}{Reference} \\ \midrule
		\endfirsthead
