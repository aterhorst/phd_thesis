...
\multirow{2}{=}{2} & \multirow{2}{=}{Successful open innovation requires deliberate brokerage actions that lead to network closure.} & Connecting people \\
...
\begin{table}[hbt!]
\centering
\caption[Breakdown of sentiment]{Breakdown of sentiment by interviewee. Colours indicate the relative strength or dominance of a particular sentiment -- the redder the colour, the more dominant is the particular sentiment expressed by the interviewee.}
...
\begin{displayquote}[Participant 10/2]
\small
...
\begin{table}[htbp]
\small
\caption[Top five normalised code references for each case]{Top five normalised code references for each case (covering the top 50\% or so of code references). Note that innate needs received fewer than five mentions in each case. The breakdown of codes allows one to compare and contrast cases.}
\label{tab:filtered_codes}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lllrrr}
\toprule
Category code & Provisional code & Detailed code & Case 1 & Case 2 & Case 3 \\ 
\midrule
Innate needs & Seeking autonomy & Connecting with others & 0.00 & 0.30 & 0.30 \\ 
Innate needs & Seeking autonomy & Becoming more competent & 0.40 & 1.40 & 1.00 \\ 
Innate needs & Doing satisfying work & Performing meaningful work & 2.20 & 0.90 & 0.70 \\ 
Internalised social norms & Expressing a particular worldview & Over-analysing things & 0.00 & 0.60 & 0.00 \\ 
Internalised social norms & Identifying with the collaboration & Being absolutely committed & 0.70 & 5.50 & 0.70 \\ 
Internalised social norms & Expressing a particular worldview & Navigating change & 1.10 & 0.00 & 0.00 \\ 
Internalised social norms & Expressing a particular worldview & Demonstrating a superior attitude & 1.40 & 0.30 & 0.30 \\ 
Internalised social norms & Expressing a particular worldview & Maintaining a narrow perspective & 2.20 & 0.00 & 3.80 \\ 
Mechanisms \& structures & Encountering power structures & Dealing with large organisations & 2.90 & 0.00 & 0.00 \\ 
Mechanisms \& structures & Spanning real and perceived boundaries & Communicating poorly & 2.90 & 0.00 & 6.50 \\ 
Mechanisms \& structures & Building trust relations & Demonstrating swift trust & 3.20 & 0.00 & 0.00 \\ 
Mechanisms \& structures & Spanning real and perceived boundaries & Gaining access to key people & 3.20 & 0.00 & 0.00 \\ 
Mechanisms \& structures & Building trust relations & Having open and honest discussions & 4.00 & 3.80 & 2.00 \\ 
Mechanisms \& structures & Building trust relations & Investing in relationships & 4.70 & 6.10 & 0.00 \\ 
