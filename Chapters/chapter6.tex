...
\multirow{2}{=}{1a} & \multirow{2}{=}{Open  innovation  requires  practitioners  to  connect across organisational and disciplinary boundaries so that they can transfer and apply their know-how in novel ways.} & Spanning real and perceived boundaries \\
...
\begin{table}[p]
\centering
\caption[Breakdown of sentiment]{Breakdown of sentiment by interviewee. The colours indicate the relative strength of positive or negative sentiment.}
