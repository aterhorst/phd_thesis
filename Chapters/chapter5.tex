...
% The average age of participants is relatively similar across all three cases. All three cases have participants from diverse educational backgrounds. Case 3 stands out as having the most educated participants. There are few highly central actors in the Case 1 and Case 3 networks. While this may reflect the immaturity of these two cases, it does indicate the concentration of power among a few individuals. There are fewer central actors in Case 2, indicating that most actors benefit from knowledge exchanges. Tacit knowledge appears to feature more strongly in the cases engaged in radical innovation. The liaison broker role dominates Cases 1 and 2, a sign of good inter-organisational collaboration. The coordinator broker role dominates Case 3, which is not surprising, given that almost half the participants belong to the same organisation. \medskip
